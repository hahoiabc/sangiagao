export default function TermsOfServicePage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <p className="text-sm text-muted-foreground mb-6">Cập nhật lần cuối: 24/03/2026</p>
      ...
      <div className="prose prose-sm max-w-none space-y-6 text-foreground">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3">3. Quy tắc đăng tin</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3">4. Giao dịch</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3">5. Hành vi bị cấm</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3">6. Quyền và trách nhiệm của chúng tôi</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3">7. Gói dịch vụ & Thanh toán</h2>
          <ul className="list-disc pl-6 space-y-1">
        ...
        <section>
          <h2 className="text-xl font-semibold mb-3">8. Xóa tài khoản</h2>
          <ul className="list-disc pl-6 space-y-1">
