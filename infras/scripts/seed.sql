...
('0904000001', 'member', 'Nguyễn Thị Hoa',     'https://ui-avatars.com/api/?name=Nguyen+Hoa&background=E91E63&color=fff&size=200',    '15 Lý Thái Tổ, Q.10',          'TP. Hồ Chí Minh', NOW() - interval '45 days', NOW() - interval '45 days', NOW() - interval '45 days'),
('0904000002', 'member', 'Trần Văn Bình',      'https://ui-avatars.com/api/?name=Tran+Binh&background=3F51B5&color=fff&size=200',     '27 Trần Phú',                   'Hà Nội',           NOW() - interval '42 days', NOW() - interval '42 days', NOW() - interval '42 days'),
('0904000003', 'member', 'Lê Thị Cúc',         'https://ui-avatars.com/api/?name=Le+Cuc&background=4CAF50&color=fff&size=200',        '39 Nguyễn Văn Linh',            'Đà Nẵng',          NOW() - interval '40 days', NOW() - interval '40 days', NOW() - interval '40 days'),
('0904000004', 'member', 'Phạm Quốc Dũng',     'https://ui-avatars.com/api/?name=Pham+Dung&background=FF9800&color=fff&size=200',     '51 Lê Lợi',                     'Cần Thơ',          NOW() - interval '38 days', NOW() - interval '38 days', NOW() - interval '38 days'),
('0904000005', 'member', 'Hoàng Thị Én',       'https://ui-avatars.com/api/?name=Hoang+En&background=9C27B0&color=fff&size=200',      '63 Hai Bà Trưng',               'Hải Phòng',        NOW() - interval '36 days', NOW() - interval '36 days', NOW() - interval '36 days'),
('0904000006', 'member', 'Võ Đức Phong',        'https://ui-avatars.com/api/?name=Vo+Phong&background=00BCD4&color=fff&size=200',      '75 Phan Đình Phùng',            'Huế',              NOW() - interval '34 days', NOW() - interval '34 days', NOW() - interval '34 days'),
('0904000007', 'member', 'Đặng Thị Giang',     'https://ui-avatars.com/api/?name=Dang+Giang&background=795548&color=fff&size=200',    '87 Nguyễn Trãi',                'Bình Dương',       NOW() - interval '32 days', NOW() - interval '32 days', NOW() - interval '32 days'),
('0904000008', 'member', 'Bùi Văn Hà',         'https://ui-avatars.com/api/?name=Bui+Ha&background=607D8B&color=fff&size=200',        '99 Võ Văn Kiệt',                'Đồng Nai',         NOW() - interval '30 days', NOW() - interval '30 days', NOW() - interval '30 days'),
('0904000009', 'member', 'Ngô Thị Lan Anh',    'https://ui-avatars.com/api/?name=Ngo+Lan&background=F44336&color=fff&size=200',       '111 Điện Biên Phủ',             'Nha Trang',        NOW() - interval '28 days', NOW() - interval '28 days', NOW() - interval '28 days'),
('0904000010', 'member', 'Lý Minh Khôi',       'https://ui-avatars.com/api/?name=Ly+Khoi&background=2196F3&color=fff&size=200',       '123 Trần Hưng Đạo',            'Vũng Tàu',         NOW() - interval '26 days', NOW() - interval '26 days', NOW() - interval '26 days'),
('0904000011', 'member', 'Trương Thị Linh',    'https://ui-avatars.com/api/?name=Truong+Linh&background=8BC34A&color=fff&size=200',   '135 Nguyễn Du',                 'Long Xuyên',       NOW() - interval '24 days', NOW() - interval '24 days', NOW() - interval '24 days'),
('0904000012', 'member', 'Mai Văn Minh',        'https://ui-avatars.com/api/?name=Mai+Minh&background=FFC107&color=333&size=200',      '147 Lê Duẩn',                   'Quy Nhơn',         NOW() - interval '22 days', NOW() - interval '22 days', NOW() - interval '22 days'),
('0904000013', 'member', 'Đinh Thị Ngà',       'https://ui-avatars.com/api/?name=Dinh+Nga&background=673AB7&color=fff&size=200',      '159 Phan Chu Trinh',            'Buôn Ma Thuột',    NOW() - interval '20 days', NOW() - interval '20 days', NOW() - interval '20 days'),
('0904000014', 'member', 'Phan Quốc Oai',      'https://ui-avatars.com/api/?name=Phan+Oai&background=009688&color=fff&size=200',      '171 Bạch Đằng',                 'Đà Lạt',           NOW() - interval '18 days', NOW() - interval '18 days', NOW() - interval '18 days'),
('0904000015', 'member', 'Huỳnh Thị Phúc',     'https://ui-avatars.com/api/?name=Huynh+Phuc&background=FF5722&color=fff&size=200',    '183 Trường Chinh',              'Thanh Hóa',        NOW() - interval '16 days', NOW() - interval '16 days', NOW() - interval '16 days'),
('0904000016', 'member', 'Lê Văn Quang',       'https://ui-avatars.com/api/?name=Le+Quang&background=E040FB&color=fff&size=200',      '195 Hùng Vương',                'Vinh',             NOW() - interval '14 days', NOW() - interval '14 days', NOW() - interval '14 days'),
('0904000017', 'member', 'Trần Thị Rạng',      'https://ui-avatars.com/api/?name=Tran+Rang&background=76FF03&color=333&size=200',     '207 Nguyễn Văn Cừ',            'Thái Nguyên',      NOW() - interval '12 days', NOW() - interval '12 days', NOW() - interval '12 days'),
('0904000018', 'member', 'Nguyễn Đức Sơn',     'https://ui-avatars.com/api/?name=Nguyen+Son&background=40C4FF&color=333&size=200',    '219 Lê Hồng Phong',            'Nam Định',         NOW() - interval '10 days', NOW() - interval '10 days', NOW() - interval '10 days'),
('0904000019', 'member', 'Phạm Thị Trang',     'https://ui-avatars.com/api/?name=Pham+Trang&background=FF6E40&color=fff&size=200',    '231 Ngô Quyền',                'Hải Dương',        NOW() - interval '8 days',  NOW() - interval '8 days',  NOW() - interval '8 days'),
('0904000020', 'member', 'Hoàng Văn Uy',       'https://ui-avatars.com/api/?name=Hoang+Uy&background=EA80FC&color=333&size=200',      '243 Trần Quang Diệu',          'Ninh Bình',        NOW() - interval '6 days',  NOW() - interval '6 days',  NOW() - interval '6 days'),
('0904000021', 'member', 'Võ Thị Vân',         'https://ui-avatars.com/api/?name=Vo+Van&background=0D8ABC&color=fff&size=200',        '255 Lý Tự Trọng',              'TP. Hồ Chí Minh',  NOW() - interval '44 days', NOW() - interval '44 days', NOW() - interval '44 days'),
('0904000022', 'member', 'Đặng Quốc Xuân',     'https://ui-avatars.com/api/?name=Dang+Xuan&background=4CAF50&color=fff&size=200',     '267 Pasteur',                   'Hà Nội',           NOW() - interval '41 days', NOW() - interval '41 days', NOW() - interval '41 days'),
('0904000023', 'member', 'Bùi Thị Yến',        'https://ui-avatars.com/api/?name=Bui+Yen&background=FF9800&color=fff&size=200',       '279 Cách Mạng Tháng 8',        'Đà Nẵng',          NOW() - interval '39 days', NOW() - interval '39 days', NOW() - interval '39 days'),
('0904000024', 'member', 'Ngô Văn An',         'https://ui-avatars.com/api/?name=Ngo+An&background=9C27B0&color=fff&size=200',        '291 Nam Kỳ Khởi Nghĩa',        'Cần Thơ',          NOW() - interval '37 days', NOW() - interval '37 days', NOW() - interval '37 days'),
('0904000025', 'member', 'Lý Thị Bé',          'https://ui-avatars.com/api/?name=Ly+Be&background=00BCD4&color=fff&size=200',         '303 Lê Lai',                    'Bình Dương',       NOW() - interval '35 days', NOW() - interval '35 days', NOW() - interval '35 days'),
('0904000026', 'member', 'Trương Văn Công',     'https://ui-avatars.com/api/?name=Truong+Cong&background=795548&color=fff&size=200',   '315 Đinh Tiên Hoàng',           'Đồng Nai',         NOW() - interval '33 days', NOW() - interval '33 days', NOW() - interval '33 days'),
('0904000027', 'member', 'Mai Thị Diệu',       'https://ui-avatars.com/api/?name=Mai+Dieu&background=607D8B&color=fff&size=200',      '327 Trần Phú',                  'Hải Phòng',        NOW() - interval '31 days', NOW() - interval '31 days', NOW() - interval '31 days'),
('0904000028', 'member', 'Đinh Hoàng Gia',     'https://ui-avatars.com/api/?name=Dinh+Gia&background=F44336&color=fff&size=200',      '339 Nguyễn Thái Học',           'Huế',              NOW() - interval '29 days', NOW() - interval '29 days', NOW() - interval '29 days'),
('0904000029', 'member', 'Phan Thị Hiền',      'https://ui-avatars.com/api/?name=Phan+Hien&background=3F51B5&color=fff&size=200',     '351 Võ Thị Sáu',               'Nha Trang',        NOW() - interval '27 days', NOW() - interval '27 days', NOW() - interval '27 days'),
('0904000030', 'member', 'Huỳnh Văn Kiên',     'https://ui-avatars.com/api/?name=Huynh+Kien&background=8BC34A&color=fff&size=200',    '363 Nguyễn Bỉnh Khiêm',        'Vũng Tàu',         NOW() - interval '25 days', NOW() - interval '25 days', NOW() - interval '25 days'),
('0904000031', 'member', 'Lê Thị Liễu',        'https://ui-avatars.com/api/?name=Le+Lieu&background=FFC107&color=333&size=200',       '375 Trần Khánh Dư',            'Long Xuyên',       NOW() - interval '23 days', NOW() - interval '23 days', NOW() - interval '23 days'),
('0904000032', 'member', 'Trần Minh Nhân',     'https://ui-avatars.com/api/?name=Tran+Nhan&background=673AB7&color=fff&size=200',     '387 Phan Bội Châu',             'Quy Nhơn',         NOW() - interval '21 days', NOW() - interval '21 days', NOW() - interval '21 days'),
('0904000033', 'member', 'Nguyễn Thị Oanh',    'https://ui-avatars.com/api/?name=Nguyen+Oanh&background=009688&color=fff&size=200',   '399 Lê Đại Hành',              'Buôn Ma Thuột',    NOW() - interval '19 days', NOW() - interval '19 days', NOW() - interval '19 days'),
('0904000034', 'member', 'Phạm Đình Phát',     'https://ui-avatars.com/api/?name=Pham+Phat&background=FF5722&color=fff&size=200',     '411 Trần Bình Trọng',           'Đà Lạt',           NOW() - interval '17 days', NOW() - interval '17 days', NOW() - interval '17 days'),
('0904000035', 'member', 'Hoàng Thị Quỳnh',    'https://ui-avatars.com/api/?name=Hoang+Quynh&background=E040FB&color=fff&size=200',   '423 Nguyễn Công Trứ',           'Thanh Hóa',        NOW() - interval '15 days', NOW() - interval '15 days', NOW() - interval '15 days'),
('0904000036', 'member', 'Võ Thanh Sang',       'https://ui-avatars.com/api/?name=Vo+Sang&background=76FF03&color=333&size=200',       '435 Lý Chính Thắng',            'Vinh',             NOW() - interval '13 days', NOW() - interval '13 days', NOW() - interval '13 days'),
('0904000037', 'member', 'Đặng Thị Thi',       'https://ui-avatars.com/api/?name=Dang+Thi&background=40C4FF&color=333&size=200',      '447 Phạm Văn Đồng',            'Thái Nguyên',      NOW() - interval '11 days', NOW() - interval '11 days', NOW() - interval '11 days'),
('0904000038', 'member', 'Bùi Đức Thắng',      'https://ui-avatars.com/api/?name=Bui+Thang&background=FF6E40&color=fff&size=200',     '459 Đinh Công Tráng',           'Nam Định',         NOW() - interval '9 days',  NOW() - interval '9 days',  NOW() - interval '9 days'),
('0904000039', 'member', 'Ngô Thị Uyển',       'https://ui-avatars.com/api/?name=Ngo+Uyen&background=EA80FC&color=333&size=200',      '471 Nguyễn Đình Chiểu',         'Hải Dương',        NOW() - interval '7 days',  NOW() - interval '7 days',  NOW() - interval '7 days'),
('0904000040', 'member', 'Lý Hoàng Vũ',        'https://ui-avatars.com/api/?name=Ly+Vu&background=B388FF&color=333&size=200',         '483 Trần Cao Vân',              'Ninh Bình',        NOW() - interval '5 days',  NOW() - interval '5 days',  NOW() - interval '5 days')
ON CONFLICT (phone) DO NOTHING;
...
BEGIN
  ...
  SELECT COUNT(*) INTO v_buyers FROM users WHERE phone LIKE '0904%' AND role = 'member';
