...
type CommissionRule struct {
	...
	Stage3Pct       float64    `json:"stage3_pct"`        // lần 3+ (giới hạn bởi stage3_cap_months)
	Stage3CapMonths int        `json:"stage3_cap_months"` // 0 = vĩnh viễn; >0 = số tháng kể từ referred_at
