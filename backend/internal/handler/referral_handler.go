...
func (h *ReferralHandler) GetTerms(c *gin.Context) {
	...
	var stage1Days, stage2Days, stage3CapMonths int
	...
	c.JSON(http.StatusOK, gin.H{
		...
		"rule": gin.H{
			...
			"stage3_cap_months": stage3CapMonths,
