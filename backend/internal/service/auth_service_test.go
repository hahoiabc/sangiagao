...
func (m *mockUserRepo) ListTrialUsers(ctx context.Context) ([]*model.User, error) {
	args := m.Called(ctx)
	if args.Get(0) == nil {
		return nil, args.Error(1)
	}
...
func (m *mockUserRepo) CreateByAdmin(ctx context.Context, phone, name, passwordHash, role string, isInternal bool) (*model.User, error) {
...
func (m *mockSubRepo) MarkReminderSent(ctx context.Context, subscriptionID string) error {
